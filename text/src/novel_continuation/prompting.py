"""Prompt templates for the continuation runs."""
...
def build_prompt(
    ...
    if context_format == "plain":
        ...
        # Show paragraph breaks explicitly in the structured prompt.
    ...
    if include_retrieval and retrieval_items:
        ...
        # Keep retrieved passages separate from the main context.
        if context_format == "plain":
