"""Run three-seed generation and evaluation for one trained model."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run generation and metrics over fixed seeds.")
    ...
    parser.add_argument("--skip-existing", action="store_true", help="Reuse finished seed files and fill only the missing pieces.")
    ...
    def ensure_model_loaded():
        ...
        # Load the checkpoint once and reuse it across seeds.
    ...
    for seed in args.seeds:
        ...
        # Reuse completed files so a disconnected Colab session can resume.
    ...
    # Rebuild the summary from whatever per-seed metrics were collected.
