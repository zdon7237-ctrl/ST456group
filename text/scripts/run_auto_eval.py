"""Score generated continuations with the automatic metrics."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compute metrics for generated continuations.")
    ...
    # Load the checkpoint so perplexity uses the same model family as generation.
